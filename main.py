...
black_player_select = gui.Select(width=150, height=70, font=TNR32)
...
table.td(gui.Label())
white_player_select = gui.Select(width=150, height=70, font=TNR32)
...
black_time_select = gui.Select("Czarny", width=130, height=70)
...
black_time_select._setvalue(black_player_select.widgets[0])
black_time_select.resize(130,70)

table.td(black_time_select, colspan=1, x=400, y=200)

table.td(gui.Label())
white_time_select = gui.Select("Biały", width=130, height=70)
